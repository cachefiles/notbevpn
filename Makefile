...
toyclient: main.o conntrack.o conntcpup.o socksify.o tcpuputils.o conndgram.o portpool.o udp_link.o icmp_link.o base_link.o jni/firewall.o jni/router.o tx_debug.o
	$(CC) -o $@ $(LDFLAGS) $^ $(LDLIBS)
